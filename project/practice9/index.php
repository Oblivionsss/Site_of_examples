<?php 
    ...
    echo "K - Киса, M - Мышка, @ - Спящая киса <br>";
    echo "Описание смотри по ссылке на гитхаб<br><br>";
    ...
    // Также кошка ведет себя странно если много мышек, так как нет оценки наиболее выгодной для поедания мышки. Но мне лень :\
