<?php
    ...
    function checkEr ($text){
        ...
        echo "<br><br>Ваш полностью исправленный текст:";
        echo $text;
    }

    echo "<br><br>Попробуйте и вы свои силы. Программа ищет наиболее популярные 
    ошибки синтаксиса и правописания.<br><br>";

    echo<<<_END
<form action="index2.php" method="post">
<textarea rows="5"      cols="40"   name="text" id="text"></textarea>
<input type="submit"    name="go"   value="Проверить правописание"></form>
_END;
