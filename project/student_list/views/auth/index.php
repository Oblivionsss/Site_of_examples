			...
			<div class="form-group">
				...
				<label for="email" class="cols-sm-2 control-label">Укажите ваш пол</label>
					<div class="input-group">
						...
						<?php if ($user['Sex'] == 'man') : echo<<<_END
						<input type="radio"  name="radio"	value="man" checked> Man<br>
						<input type="radio"  name="radio"	value="woman"> Woman<br>
_END;
?>
						<?php else : echo<<<_END
						<input type="radio"  name="radio"	value="man"> Man<br>
						<input type="radio"  name="radio"	value="woman" checked> Woman<br>
_END;
?>
						<?php endif;?>
					</div>
			...
			<div class="form-group">
				...
				<div class="cols-sm-10">
					<div class="input-group">
                        ...
                        <?php echo<<<_END
                        <input type="text" class="form-control" name="numberOfGroups" value="{$user['Groupss']}">
_END;
?>
					</div>
				</div>
			...
			<div class="form-group">
				...
				<div class="cols-sm-10">
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                        <?php echo<<<_END
                        <input type="text" class="form-control" name="balls" value="{$user['Balls']}"/>
_END;
?>
					</div>
				</div>
			...
			<div class="form-group">
				...
				<div class="cols-sm-10">
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                        <?php echo<<<_END
                        <input type="text" class="form-control" name="e_mail" value="{$user['Email']}"/>
_END;
?>
					</div>
				</div>
...
?>
			...
			<div class="form-group ">
				<input type="submit" class="btn btn-primary btn-lg btn-block login-buttonl" name="moidfy"  title="Изменить" title="Изменить"/>
			</div>
